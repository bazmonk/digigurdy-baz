...
int crankmodulepresent; // 1 == crank present, 0 == crank missing

// Value from about 100 to 500, sets how frequently to sample the crank
// voltage to see if buzz threshold has, or still is, exceeded
int buzzsamplinginterval = 100;

// Bigger value makes buzz last longer before it decays to zero after
// each initiation.
int buzzcountdownstartvalue = 1000;
int buzzcountdown2startvalue = 1000;

// This threshold affects detection of the crank turning, not the buzzing itself.
// Approx 15 to 25
int dronethreshold = 25;
...
// Velocity of melody notes range  zero to 127
int noteVol = 56;
